                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="fw-bolder text-dark">Penggunaan Obat</span>
                            ...
                            <div class="card-toolbar">
                                ...
                                <!--begin::Menu 1-->
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6155b484a57ea">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6155b484a57ea" data-allow-clear="true">
                                                    <option></option>
...
<?php endif; ?><?php /**PATH D:\KULIAH\DICODING\laragon\www\perpustakaanSDN\resources\views/pages/dashboard/main.blade.php ENDPATH**/ ?>
        ...
        <div class="w-lg-500px p-10 p-lg-15 mx-auto">
            <form class="form w-100" novalidate="novalidate" id="form_login">
                <div class="text-center mb-10">
                    <h1 class="text-dark mb-3">Masuk ke <br> {{config('app.name')}}</h1>
                </div>
                ...
                <div class="text-center">
                    <button id="tombol_login" onclick="handle_post('#tombol_login','#form_login','{{route('web.auth.login')}}');" data-login="3" class="btn btn-lg btn-primary w-100 mb-5">
